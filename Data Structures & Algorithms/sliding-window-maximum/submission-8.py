...
class Solution:
    def maxSlidingWindow(self, nums: List[int], window_size: int) -> List[int]:
        ...
        result = []                  # Stores the maximums for each window
        index_deque = deque()        # Stores indices of useful elements
        left_pointer = 0             # Left boundary of the window
        right_pointer = 0            # Right boundary of the window
